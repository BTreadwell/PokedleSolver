...
The core implementation is the same across these three algorithms and can be found in [get_next_guess](guessing_strategies.py).
...
The different guessing strategies/optimal algorithms are implemented in [guessing_strategies.py](guessing_strategies.py).
