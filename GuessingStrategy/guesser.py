...
from GuessingStrategy.scorer import Scorer, optimal_entropy_scorer, optimal_knuth_wc_scorer, optimal_knuth_avg_scorer
from GuessingStrategy.selector import Selector, optimal_selector
